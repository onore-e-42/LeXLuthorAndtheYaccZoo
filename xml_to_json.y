...
%token<sval> ATT_EDITION ATT_ID ATT_TITLE OPEN_CLOSE AUTHORNOTES CLOSE_TAG START_TAG AUTHORNOTES OPEN_CLOSE BOOK CLOSE_TAG START_TAG BOOK OPEN_CLOSE CELL CLOSE_TAG START_TAG CELL OPEN_CLOSE CHAPTER CLOSE_TAG START_TAG CHAPTER CLOSE_TAG OPEN_CLOSE DEDICATION CLOSE_TAG START_TAG DEDICATION END_TAG OPEN_CLOSE FIGURE CLOSE_TAG START_TAG FIGURE OPEN_CLOSE ITEM CLOSE_TAG START_TAG ITEM OPEN_CLOSE LOF CLOSE_TAG START_TAG LOF OPEN_CLOSE LOT CLOSE_TAG START_TAG LOT OPEN_CLOSE NOTE CLOSE_TAG START_TAG NOTE OPEN_CLOSE PART CLOSE_TAG START_TAG PART OPEN_CLOSE PREFACE CLOSE_TAG START_TAG PREFACE OPEN_CLOSE ROW CLOSE_TAG START_TAG ROW OPEN_CLOSE SECTION CLOSE_TAG START_TAG SECTION STRING OPEN_CLOSE TABLE CLOSE_TAG START_TAG TABLE TEXT OPEN_CLOSE TOC CLOSE_TAG START_TAG TOC ATT_CAPTION ATT_PATH KEYWORD 
